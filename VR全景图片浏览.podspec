...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "yongqiang.zhao@camdora.me"
  # s.authors            = { "yongqiang.zhao@camdora.me" => "yongqiang.zhao@camdora.me" }
  # s.social_media_url   = "http://twitter.com/yongqiang.zhao@camdora.me"
